...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_customerDemandId_fkey" FOREIGN KEY ("customerDemandId") REFERENCES "CustomerDemand"("id") ON DELETE SET NULL ON UPDATE CASCADE;
